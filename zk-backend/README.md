...
> **Nota:** As etapas 5 e 6 (conversão para formato hex) ainda não estão disponíveis via JavaScript. Para estas etapas, você precisará usar os comandos CLI correspondentes.
